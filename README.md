...
The project is currently hosted and available for live testing. You can access the application here:

🔗 [https://stock.spryte.cloud](https://stock.spryte.cloud)
...
> **Note on Frontend:**
> While this project focuses primarily on backend architecture and logic, a fully functional **Frontend** has been included to improve usability and presentation. This frontend was **generated by AI** to provide a visual interface for interacting with the backend API.
...
* `POST /api/auth/registration`: Create a new user account.
